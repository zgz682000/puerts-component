...
{
    public static class Puerts_Component_TsComponent_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new Puerts.Component.TsComponent();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Puerts.Component.TsComponent), result);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_Transporter(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.Component.TsComponent;
                var result = obj.Transporter;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_tsModulePath(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.Component.TsComponent;
                var result = obj.tsModulePath;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_tsModulePath(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.Component.TsComponent;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.tsModulePath = argHelper.GetString(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_hookNames(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.Component.TsComponent;
                var result = obj.hookNames;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_hookNames(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Puerts.Component.TsComponent;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.hookNames = argHelper.Get<System.Collections.Generic.List<string>>(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"hookNames", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_hookNames, Setter = S_hookNames} }
                },
